function myFunctionSenin() {
    let jumbo = document.getElementById("content");
    let cont = document.getElementById("addJadwalSenin");
    let buton = document.getElementById("tombolSenin");
    ...
    let formCover = document.getElementById("cover-input-senin");
    let form = document.getElementById("tambah_senin");
    ...
    button1.setAttribute("onclick", "deleteRowSenin(this)");
    button1.setAttribute("value","Delete");

    buton.setAttribute("onclick", "tambahrow1Senin()");
    ...
    table.setAttribute("id","myTableSenin")

    tBody.setAttribute("id", "tambahDataSenin")
    inputText.setAttribute("type", "text");
    inputText.setAttribute("id", "jadwal");
    inputText.setAttribute("name", "jadwalSenin"+'[]');
    inputText.setAttribute("required", "");
    inputText.setAttribute("maxlength", "40");

    inputTime.setAttribute("type", "time");
    inputTime.setAttribute("id", "waktu");
    inputTime.setAttribute("name", "waktuSenin"+'[]');
...
function tambahrow1Senin() {
    // i++;
    let jumbo = document.getElementById("content");
    let tombol = document.getElementById("tombolSenin");

    let buttonD = document.getElementById("submitSenin");
    let bodyTabel = document.getElementById("tambahDataSenin");
