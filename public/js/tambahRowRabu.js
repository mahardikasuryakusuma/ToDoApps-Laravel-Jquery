function myFunctionRabu() {
    let jumbo = document.getElementById("content");
    let cont = document.getElementById("addJadwalRabu");
    let buton = document.getElementById("tombolRabu");
    ...
    let formCover = document.getElementById("cover-input-rabu");
    let form = document.getElementById("tambah_rabu");
    ...
    button1.setAttribute("onclick", "deleteRowRabu(this)");
    button1.setAttribute("value","Delete");

    buton.setAttribute("onclick", "tambahrow1Rabu()");
    ...
    table.setAttribute("id","myTableRabu")

    tBody.setAttribute("id", "tambahDataRabu")
    inputText.setAttribute("type", "text");
    inputText.setAttribute("id", "jadwal");
    inputText.setAttribute("name", "jadwalRabu"+'[]');
    inputText.setAttribute("required", "");
    inputText.setAttribute("maxlength", "40");

    inputTime.setAttribute("type", "time");
    inputTime.setAttribute("id", "waktu");
    inputTime.setAttribute("name", "waktuRabu"+'[]');
...
function tambahrow1Rabu() {
    // i++;
    let jumbo = document.getElementById("content");
    let tombol = document.getElementById("tombolRabu");

    let buttonD = document.getElementById("submitRabu");
    let bodyTabel = document.getElementById("tambahDataRabu");
