function myFunctionSabtu() {
    let jumbo = document.getElementById("content");
    let cont = document.getElementById("addJadwalSabtu");
    let buton = document.getElementById("tombolSabtu");
    ...
    let formCover = document.getElementById("cover-input-sabtu");
    let form = document.getElementById("tambah_sabtu");
    ...
    button1.setAttribute("onclick", "deleteRowSabtu(this)");
    button1.setAttribute("value","Delete");

    buton.setAttribute("onclick", "tambahrow1Sabtu()");
    ...
    table.setAttribute("id","myTableSabtu")

    tBody.setAttribute("id", "tambahDataSabtu")
    inputText.setAttribute("type", "text");
    inputText.setAttribute("id", "jadwal");
    inputText.setAttribute("name", "jadwalSabtu"+'[]');
    inputText.setAttribute("required", "");
    inputText.setAttribute("maxlength", "40");

    inputTime.setAttribute("type", "time");
    inputTime.setAttribute("id", "waktu");
    inputTime.setAttribute("name", "waktuSabtu"+'[]');
...
function tambahrow1Sabtu() {
    let jumbo = document.getElementById("content");
    let tombol = document.getElementById("tombolSabtu");

    let buttonD = document.getElementById("submitSabtu");
    let bodyTabel = document.getElementById("tambahDataSabtu");
