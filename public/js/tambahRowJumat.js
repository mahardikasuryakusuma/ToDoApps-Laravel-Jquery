function myFunctionJumat() {
    let jumbo = document.getElementById("content");
    let cont = document.getElementById("addJadwalJumat");
    let buton = document.getElementById("tombolJumat");
    ...
    let formCover = document.getElementById("cover-input-jumat");
    let form = document.getElementById("tambah_jumat");
    ...
    button1.setAttribute("onclick", "deleteRowJumat(this)");
    button1.setAttribute("value","Delete");

    buton.setAttribute("onclick", "tambahrow1Jumat()");
    ...
    table.setAttribute("id","myTableJumat")

    tBody.setAttribute("id", "tambahDataJumat")
    inputText.setAttribute("type", "text");
    inputText.setAttribute("id", "jadwal");
    inputText.setAttribute("name", "jadwalJumat"+'[]');
    inputText.setAttribute("required", "");
    inputText.setAttribute("maxlength", "40");

    inputTime.setAttribute("type", "time");
    inputTime.setAttribute("id", "waktu");
    inputTime.setAttribute("name", "waktuJumat"+'[]');
...
function tambahrow1Jumat() {
    let jumbo = document.getElementById("content");
    let tombol = document.getElementById("tombolJumat");

    let buttonD = document.getElementById("submitJumat");
    let bodyTabel = document.getElementById("tambahDataJumat");
