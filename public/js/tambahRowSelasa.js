function myFunctionSelasa() {
    let jumbo = document.getElementById("content");
    let cont = document.getElementById("addJadwalSelasa");
    let buton = document.getElementById("tombolSelasa");
    ...
    let formCover = document.getElementById("cover-input-selasa");
    let form = document.getElementById("tambah_selasa");
    ...
    button1.setAttribute("onclick", "deleteRowSelasa(this)");
    button1.setAttribute("value","Delete");

    buton.setAttribute("onclick", "tambahrow1Selasa()");
    ...
    table.setAttribute("id","myTableSelasa")

    tBody.setAttribute("id", "tambahDataSelasa")
    inputText.setAttribute("type", "text");
    inputText.setAttribute("id", "jadwal");
    inputText.setAttribute("name", "jadwalSelasa"+'[]');
    inputText.setAttribute("required", "");
    inputText.setAttribute("maxlength", "40");

    inputTime.setAttribute("type", "time");
    inputTime.setAttribute("id", "waktu");
    inputTime.setAttribute("name", "waktuSelasa"+'[]');
...
function tambahrow1Selasa() {
    // i++;
    let jumbo = document.getElementById("content");
    let tombol = document.getElementById("tombolSelasa");
    let buttonD = document.getElementById("submitSelasa");
    let bodyTabel = document.getElementById("tambahDataSelasa");
